        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 max-w-md mx-auto w-full space-y-6">
            <div className="text-center space-y-2">
              ...
              {user ? (
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-mono font-bold text-nexora-orange-400">{user.email}</p>
                </div>
              ) : (
                <p className="text-xs sm:text-sm text-neutral-400">
                  Sign in to access your sovereign healthcare enclave
                </p>
              )}
            </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#0D1322] border border-white/10 focus:border-nexora-orange-500 text-white text-sm focus:outline-none transition-all placeholder:text-neutral-600"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-neutral-400 hover:text-nexora-orange-400 cursor-pointer">
                      Forgot password?
                    </span>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="w-full px-4 py-3 rounded-xl bg-[#0D1322] border border-white/10 focus:border-nexora-orange-500 text-white text-sm focus:outline-none transition-all placeholder:text-neutral-600 pr-10"
                    />
                    <button
                      type="button"
            ...
            <div className="pt-2 text-center text-xs text-neutral-400">
              ...
              <Link href="/register" className="text-nexora-orange-400 hover:underline font-semibold">
                Create one now →
              </Link>
            </div>
          </div>

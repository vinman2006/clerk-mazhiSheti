      ...
      {showText && (
        <div className="flex flex-col">
          <div className="flex items-center gap-2">
            ...
            {showBadge && (
              <span className="font-sans font-black text-[10px] px-2 py-0.5 rounded-md bg-nexora-orange-500 text-nexora-text-on-orange leading-none shadow-sm tracking-wide">
                नेक्सोरा
              </span>
            )}
          </div>
          <span className="font-sans font-bold text-[10px] text-nexora-steel-300 tracking-wider uppercase -mt-0.5">
            {subtitle}
          </span>
        </div>
      )}

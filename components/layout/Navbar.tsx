...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-200">
      {/* Top Utility Nav Bar */}
      <div className={`bg-nexora-bg-header/95 backdrop-blur-md border-b border-nexora-border-subtle transition-all duration-200 ${scrolled ? 'py-2.5 shadow-xl' : 'py-3.5'}`}>
